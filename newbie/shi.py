...
Button1=wx.Button(bkg,label='啊')
Button1.Bind(wx.EVT_BUTTON,read)

Button2=wx.Button(bkg,label='啊')
Button3=wx.Button(bkg,label='啊')
Button3.Bind(wx.EVT_BUTTON,OnMove)



Button4=wx.Button(bkg,label='啊')

Button5=wx.Button(bkg,label='啊')
Button5.Bind(wx.EVT_BUTTON,save)



Button6=wx.Button(bkg,label='啊')
Button7=wx.Button(bkg,label='啊')
...
Button1=wx.Button(bkg,label='确认')
Button1.Bind(wx.EVT_BUTTON,read)

Button2=wx.Button(bkg,label='确认')
Button3=wx.Button(bkg,label='确认')
Button3.Bind(wx.EVT_BUTTON,OnMove)



Button4=wx.Button(bkg,label='确认')

Button5=wx.Button(bkg,label='确认')
Button5.Bind(wx.EVT_BUTTON,save)



Button6=wx.Button(bkg,label='确认')
Button7=wx.Button(bkg,label='确认')
#filename=wx.TextCtrl(bkg)
contents=wx.TextCtrl(bkg,style=wx.TE_MULTILINE|wx.HSCROLL)
